...
find /app/.next \( -type d -name .git -prune \) -o -type f -print0 | xargs -0 sed -i -e "s#APP_NEXT_PUBLIC_API_SERVER_HOST#$NEXT_PUBLIC_API_SERVER_HOST#g" -e "s#APP_NEXT_PUBLIC_HOST#$NEXT_PUBLIC_HOST#g" -e "s#APP_NEXT_PUBLIC_NODE_ENV#$NEXT_PUBLIC_NODE_ENV#g" -e "s#APP_NEXT_PUBLIC_AUTH0_DOMAIN#$NEXT_PUBLIC_AUTH0_DOMAIN#g" -e "s#APP_NEXT_PUBLIC_AUTH0_CLIENT_ID#$NEXT_PUBLIC_AUTH0_CLIENT_ID#g" -e "s#APP_NEXT_PUBLIC_AUTH0_REDIRECT_URI#$NEXT_PUBLIC_AUTH0_REDIRECT_URI#g" -e "s#APP_NEXT_PUBLIC_AUTH0_REALM#$NEXT_PUBLIC_AUTH0_REALM#g" -e "s#APP_NEXT_PUBLIC_STRAPI_SERVER#$NEXT_PUBLIC_STRAPI_SERVER#g" -e "s#APP_NEXT_PUBLIC_STRAPI_HOST#$NEXT_PUBLIC_STRAPI_HOST#g" -e "s#APP_NEXT_PUBLIC_STRIPE_PUBLIC_KEY#$NEXT_PUBLIC_STRIPE_PUBLIC_KEY#g"
