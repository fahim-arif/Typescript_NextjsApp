    ...
    <header className="text-gray-600 body-font">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
          ...
          <span className="ml-3 text-xl">twoMatches</span>
        </a>
        ...
        <button className="inline-flex items-center text-white bg-red-400 border-0 py-1 px-3 mx-2 focus:outline-none hover:bg-red-500 rounded text-base mt-4 md:mt-0">
          Signup
        </button>
      </div>
    </header>
